                                            ...
                                            <form method="post" id="basic_sample_form" class="form-horizontal"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <label>NIC</label>
                                                        <input type="text" name="nic" id="contact_nic" placeholder="NIC" value="{{$employee->nic}}" class="form-control">
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 form-group">
                                                        ...
                                                        <input type="text" name="nic_expiry" id="contact_nic_expiry" placeholder="NIC Expiry" value="{{$employee->nic_expiry}}" class="form-control">
                                                    </div>
